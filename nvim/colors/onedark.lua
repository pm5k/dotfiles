...
HI(0, "WilderPopupMenuSelectedAccent", {  bg = "#16181D",  bold = true,  cterm = {    bold = true,    underline = true  },  underline = true})
...
HI(0, "@text.uri", {  cterm = {    italic = true,    underline = true  },  fg = "#61AFEF",  italic = true,  underline = true})
